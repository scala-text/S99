...
class P15Spec extends FunSpec with DiagrammedAssertions {
  describe("P15") {
    ...
    it("otherwise"){
      ...
      assert(P15.duplicateN(2, List(1, 2, 3, 3)) == List(1, 1, 2, 2, 3, 3, 3, 3))
      assert(P15.duplicateN(2, List(1, 1, 2, 3, 3)) == List(1, 1, 1, 1, 2, 2, 3, 3, 3, 3))
      assert(P15.duplicateN(2, List(1, 2, 2, 3)) == List(1, 1, 2, 2, 2, 2, 3, 3))
    }
  }
}